...
document.addEventListener("DOMContentLoaded", () => {
  ...
  findBtn.addEventListener("click", async () => {
    ...
    try {
      // This request will wait (long-poll) until a match is found or timeout
      ...
      if (data.success) {
        ...
        if (data.matched) {
          // Match found! Redirect to game page
          setStatus("Match found! Connecting to game…", true);
          ...
          showError(data.message || "No opponent found. Please try again.");
